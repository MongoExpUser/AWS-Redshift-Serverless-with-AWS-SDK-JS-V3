...
async function main()
{
    ...
    const paramsObject = {
     ...
     try
    {
        // add  "namespaceName", "adminUsername", "adminUserPassword", "iamRoles" and "defaultIamRoleArn" and "tags"
        // to the "createParameters" variable on the "paramsObject" object.
        ...
        // add "namespaceName", "workgroupName", "security group id(s)", "subnet ids"  and "tags"
        // to the "createWorkgroupParameters" variable on the "paramsObject" object.
        ...
        paramsObject.createWorkgroupParameters.securityGroupIds =  await [ 
            process.env.AWS_VPC_SECURITY_GROUP 
        ];
        paramsObject.createWorkgroupParameters.subnetIds =  await [ 
            process.env.AWS_VPC_SUBNET_ID_ONE, 
            process.env.AWS_VPC_SUBNET_ID_TWO, 
            process.env.AWS_VPC_SUBNET_ID_THREE 
        ];
