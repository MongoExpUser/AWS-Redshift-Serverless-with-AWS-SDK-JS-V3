...
#  *                                                                                                                                                   *
#  *  Additional Scripts for Modeling                                                                                                                  *
#  *  3) DDL SQL Scripts for Data Objects (Tables) Creation: Run via Redshift Query Editor 2                                                                         *
#  *  3) DML Script for Inserting Data: Run via Node.js Module @aws-sdk/client-redshift-data (AWS-SDK-JS-V3)                                          *
#  *  3) DQL Script for Running Report Queries: : Run via Redshift Query Editor 2                                                                      *
#  *****************************************************************************************************************************************************
*/
